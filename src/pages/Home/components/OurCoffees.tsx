...
const listCards:ListCardsProps[] = [
    {   
    ...
    return (
        <div className='mt-[132px] flex flex-col'>
            ...
            <div className="grid grid-cols-4 gap-8">
                ...
                {listCards.map(({idCard, info, src, text_coffee, title_coffee, info_increment, info_increment_2}) => {
                    ...
                    if(info_increment_2 != ''){
                        return(
                            ...
                            idCard={idCard}
                            src={src}
                            title_coffee={title_coffee}
                            info={info}
                            text_coffee={text_coffee}
                            info_increment={info_increment}
                            info_increment_2={info_increment_2}
                            />
